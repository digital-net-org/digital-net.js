...
test('EntityHelper: build(), Should build the entity correctly from the json object.', () => {
    const jsonObject = EntityHelper.build({ id: 'testId', createdAt: '2021-10-01T00:00:00.000Z', updatedAt: null });
    expect(jsonObject).toEqual({ id: 'testId', createdAt: new Date('2021-10-01T00:00:00.000Z'), updatedAt: undefined });
});
